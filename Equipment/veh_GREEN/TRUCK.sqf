...
_veh addItemcargoglobal ["IEDUrbanSmall_Remote_Mag",2];
...
_veh addItemcargoGlobal ["rhsgref_10Rnd_792x57_m76",6];
_veh addItemcargoGlobal ["rhs_mag_rgd5",8];
_veh addItemcargoGlobal ["rhs_mag_rdg2_white",10];
_veh addItemcargoGlobal ["rhs_VOG25",16];
_veh addItemcargoglobal ["rhs_VG40OP_white", 16];
_veh addItemcargoglobal ["rhs_VG40OP_green", 6];
_veh addItemcargoglobal ["rhs_VG40OP_red", 6];
_veh addItemcargoGlobal ["pzn_f1",8];
